...
...
<head>
	<link rel="stylesheet" href="/webjars/baloise-design-system/18.0.1/@baloise/ds-styles/css/all.min.css" />
	<script type="module" src="/webjars/baloise-design-system/18.0.1/@baloise/ds-core/dist/baloise-design-system/baloise-design-system.esm.js"></script>
	<script nomodule src="/webjars/baloise-design-system/18.0.1/@baloise/ds-core/dist/baloise-design-system/baloise-design-system.js"></script>
</head>
...
----
